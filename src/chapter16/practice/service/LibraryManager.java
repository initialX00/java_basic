...
public class LibraryManager implements Manageable {
    ...
    public LibraryManager() {
        items.add(new Book("1","자바","1","이승아","송아나라"
                ,2024,15000,5,Category.FICTION));
        items.add(new Book("1","자바","1","이승아","송아나라"
                ,2024,15000,5,Category.FANTASY));
        items.add(new Book("1","자바","1","이승아","송아나라"
                ,2024,15000,5,Category.FICTION));
        items.add(new Book("1","자바","1","이승아","송아나라"
                ,2024,15000,5,Category.NONFICTION));
        items.add(new Book("1","자바","1","이승아","송아나라"
                ,2024,15000,5,Category.HISTORY));
        items.add(new Book("1","자바","1","이승아","송아나라"
                ,2024,15000,5,Category.SCIENCE));
        items.add(new Book("1","자바","1","이승아","송아나라"
                ,2024,15000,5,Category.FICTION));
        items.add(new Book("1","자바","1","이승아","송아나라"
                ,2024,15000,5,Category.SCIENCE));
