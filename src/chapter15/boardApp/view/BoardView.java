            ...
            try{
                ...
                switch(choice) {
                    ...
                    case 4:
                        ...
                        scanner.nextLine(); //nextLong()버퍼제거
                    ...
                    case 6:
                        ...
                        return;
                    default:
                        System.out.println("잘못된 선택입니다. 0~6의 숫자를 선택해주세요");
                }
            } catch(InputMismatchException e) {
                System.out.println("입력이 유효하지 않습니다. 숫자를 입력하세요");
                scanner.nextLine(); //유효하지 않은 값을 제거 및 nextInt 버퍼 제거
            } catch(IllegalArgumentException e) {
                //인수값으로 부적절한 값을 넘길 때 던지는 에외
